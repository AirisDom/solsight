  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center px-4 py-8">
      <div className="flex w-full max-w-md flex-col items-center text-center">
        <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-destructive/10 sm:mb-6 sm:h-16 sm:w-16">
        ...
        <Link href="/" className={buttonVariants({ className: "h-11 px-6 sm:h-10" })}>
